...
bot invite link: https://discordapp.com/api/oauth2/authorize?client_id=667164281225084948&scope=bot&permissions=8 
...
client.on('message', message => {
 ...
 message.author.sendMessage(`
 **
__~~Los Angles Bot~~__ By:GNKP#4555 
╱╭╮╭╮╱╱╱╱╭╮╭━╮╱╱╱╱╱╱╭━━╮╱╱╱╭╮
╭╯╰┫┃╱╱╱╱┃┃┃╭╯╱╱╱╱╱╱┃╭╮┃╱╱╭╯╰╮
╰╮╭┫╰━┳━━┫╰╯╯╭┳━╮╭━━┫╰╯╰┳━┻╮╭╯
╱┃┃┃╭╮┃┃━┫╭╮┃┣┫╭╮┫╭╮┃╭━╮┃╭╮┃┃
...
https://discordapp.com/api/oauth2/authorize?client_id=667164281225084948&scope=bot&permissions=8 
...
console.log(`**Los Angles Bot** Leave From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
client.channels.get("390983810889678868").send('**Los Angles Bot** ``Kicked`` From Server - -- = '+`**${guild.name}**`+' = -- '+'**Server Owner** -- =' +`**${guild.owner.user.username}**` +'= --')
});
